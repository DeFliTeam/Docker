...
then
    ...
    sudo apt-get install -qq -y apt-transport-https ca-certificates curl gnupg2 slirp4netns software-properties-common uidmap w3m >/dev/null
...
echo
echo "Do you want to prepare the system for use with any of the DeFli / ADS-B containers?"
echo "Examples of these include the collection of containers maintained by @DeFli,"
echo "Tar1090, Readsb-ProtoBuf, % DeFliSoftware."
echo "It\'s safe to say YES to this question and continue."
echo
